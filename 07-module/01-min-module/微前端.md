...
* 9. 在 `workspace/container/src/index.ejs` 中，注释掉开启内容安全策略的代码
  ...
  ![image-20211123164617112](F:\LaGou\07-module\01-min-module\assets\12.png)
...
* 2. 构建路由
  ...
  <script type="systemjs-importmap">
      {
          "imports": {
              "@single-spa/welcome": "https://unpkg.com/single-spawelcome/
              dist/single-spa-welcome.js"
          }
      }
  </script>
  ```
